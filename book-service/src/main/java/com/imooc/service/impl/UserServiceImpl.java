...
public class UserServiceImpl implements UserService {
    ...
    @Autowired
    private Sid sid;
    private static final String USER_FACE1 = "http://39.105.38.113:9000/abc/211005800N0W837C/photo_001.jpg";
    ...
    public Users updateUserInfo(UpdatedUserBO updatedUserBO) {
        ...
        return getUsers(updatedUserBO.getId());
    }
    ...
    public Users updateUserInfo(UpdatedUserBO updatedUserBO, Integer type) {
        ...
        if(type == UserInfoModifyType.IMOOCNUM.type){
            ...
            Users tmpUser = getUsers(updatedUserBO.getId());
            if(tmpUser.getCanImoocNumBeUpdated() == YesOrNo.NO.type){
